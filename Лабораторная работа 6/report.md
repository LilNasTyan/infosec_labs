...
1. Установила сервер Apache

![Рис. 1](image/1.png)

2. В конфиге httpd задала параметр ServerName

![Рис. 2](image/2.png)

3. Зашла в систему, убедилась, что SELinux работает правильно и обратилась с помощью браузера к веб-серверу

![Рис. 3](image/3.png)

4. Посмотрела текущее состояние переключателей SELinux

![Рис. 4](image/4.png)

5. Посмотрела статистику по политике 

![Рис. 5](image/5.png)

6. Определила тип файлов и поддиректорий /var/www/ и /var/www/html, потом определила круг пользователей которым разрешено создание файлов. После этого создала файл test.html и проверила контекст этого файла

![Рис. 6](image/6.png)

7. Обратилась к файлу через веб-сервер, файл успешно отображён

![Рис. 7](image/7.png)

8. Изучила справку и выяснила, какие контексты файлов определены для httpd. Сопоставила их с типом файла
test.html и изменила контекст файла, проверила, что контекст поменялся

![Рис. 8](image/9.png)

9. Запустила test.html ещё раз и получила ошибку 

![Рис. 9](image/10.png)

10. Поменяла на 81 порт, перезапустила сервер, ошибка, проанализировала логи
...
12. Привязала 81 порт, проверила список портов и перезапустила сервер
...
15. Вернула контекст обратно, исправила конфиг, удалила привязку и удалила файл
